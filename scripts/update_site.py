...
from scripts import (
    ...
    migrate_privacybeleid_sitebreed,
    migrate_handleiding_bijgewerkt_op,
    migrate_club_nav,
...
STAPPEN = [
    ...
    ("Privacybeleid: webshop -> sitebreed", migrate_privacybeleid_sitebreed.run),
    ("Kolom: site_instellingen.handleiding_bijgewerkt_op", migrate_handleiding_bijgewerkt_op.run),
