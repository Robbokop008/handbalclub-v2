...
SITE_TEXT_PAGINAS = [
    {
        ...
        "label": "Homepage",
        "endpoint": "main.home",
        "opmerking": "De hero (foto + kalender-/nieuwskaart) is vaste opmaak; enkel de 5 promotiekaarten eronder zijn hier bewerkbaar.",
        "velden": [
            ...
            _tekst("promo_jeugd_titel", "Jeugdhandbal-kaart: titel", "jeugdhandbal"),
            _tekst("promo_jeugd_subtitel", "Jeugdhandbal-kaart: ondertitel", "van 6 tot 18 jaar, elke jongere kan bij ons sporten"),
            ...
            _tekst("promo_ghandbal_titel", "G-Handbal-kaart: titel", "sporten op maat van onze buitenGewone vrienden"),
            _tekst("promo_ghandbal_subtitel", "G-Handbal-kaart: ondertitel", "sporters vanaf 6 jaar met ASS of een lichte fysieke of mentale beperking"),
        ],
    },
    {
        "slug": "club",
